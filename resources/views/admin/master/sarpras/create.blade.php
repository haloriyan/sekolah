...
@section('content')
<form class="flex gap-8 p-10" method="POST" enctype="multipart/form-data" action="{{ route('admin.master.sarpras.store') }}">
    @csrf
    ...
    <div class="flex flex-col gap-8 basis-72 grow">
        ...
        <div class="bg-white shadow-lg rounded-lg flex flex-col gap-4 p-10">
            ...
            <div class="flex gap-4 flex-wrap flex-row-reverse justify-end" id="renderImages">
...
<script>
    ...
    const onSelectImage = input => {
        ...
        reader.onload = function () {
            ...
            select("#renderImages").appendChild(item);
        }

        reader.readAsDataURL(file);
    }

    const removeImg = that => {
