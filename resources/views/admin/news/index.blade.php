...
<div class="p-10">
    ...
    <div class="flex items-center gap-4">
        ...
        <a href="{{ route('admin.content.news.create') }}" class="bg-primary text-white p-3 px-6 rounded font-medium flex items-center gap-4">
                ...
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td class="p-1 flex items-center gap-2">
                            <a href="{{ route('admin.content.news.edit', $post->id) }}" class="cursor-pointer text-white bg-primary p-2 px-4 text-sm mt-4">
...
<div class="fixed top-0 left-0 right-0 bottom-0 bg-white bg-opacity-75 flex items-center justify-center hidden" id="deleteModal">
    <form class="bg-white shadow-lg rounded-lg p-10 w-4/12 mobile:w-10/12" method="POST" action="{{ route('admin.content.news.delete') }}">
        @csrf
